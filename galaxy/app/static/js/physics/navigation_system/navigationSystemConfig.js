...
export const NAVIGATION_DEFAULTS = Object.freeze({
  ...
  estimator: Object.freeze({
    ...
    dsnNearCadenceSec: 45,
    dsnCoastCadenceSec: 180,
    dsnLightTimeUncertaintyScale: 0.0015,
    starTrackerLosSigmaDeg: 0.009,
    opticalNavLosSigmaDeg: 0.004,
    opticalNavMoonRangeKm: 120_000,
    opticalNavEarthRangeKm: 180_000,
    imuAccelBiasKmS2: 1.2e-8,
    imuAccelNoiseKmS2: 2.8e-8,
