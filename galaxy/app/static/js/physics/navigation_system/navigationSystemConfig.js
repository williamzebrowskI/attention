...
export const NAVIGATION_DEFAULTS = Object.freeze({
  ...
  planner: Object.freeze({
    ...
    moonLambertCentralBodyMuKm3S2: 398600.4418,
    moonLambertCadenceSec: 45,
    moonLambertMinTofSec: 42 * 3600,
    moonLambertMaxTofSec: 120 * 3600,
    moonLambertTofStepSec: 3600,
    moonLambertTliBurnDvDeadbandKmS: 0.01,
    moonLambertMidcourseDvDeadbandKmS: 0.004,
    moonLambertBurnMaxDvKmS: 1.8,
    moonLambertThrottleDvScaleKmS: 1.2,
    moonLambertThrottleMin: 0.08,
    moonLambertThrottleMax: 0.78,
